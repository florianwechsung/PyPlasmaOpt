...
def example3_get_objective():
    ...
    obj = Problem2_Objective(
        ...
        iota_target=iota_target, coil_length_target=coil_length_target, magnetic_axis_length_target=magnetic_axis_length_target,
        ...
        eta_bar=eta_bar, mode='deterministic', outdir=outdir)
    return obj, args
