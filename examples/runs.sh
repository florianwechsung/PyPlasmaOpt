for seed in 3; do
    ...
    for mode in deterministic; do
        python3 example2.py      --mode $mode --sigma 0.003 --length-scale 0.2 --seed $seed --nsamples 100 --curvature-penalty 0 --torsion-penalty 0 --tikhonov 0 --arclength 0 --distance-weight 0 --minimum-distance 0.1 --sobolev 0
        python3 example2_plot.py --mode $mode --sigma 0.003 --length-scale 0.2 --seed $seed --nsamples 100 --curvature-penalty 0 --torsion-penalty 0 --tikhonov 0 --arclength 0 --distance-weight 0 --minimum-distance 0.1 --sobolev 0
