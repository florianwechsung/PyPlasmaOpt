...
ext_modules = [
    Extension(
        'cppplasmaopt',
        ['cppplasmaopt/main.cpp', 'cppplasmaopt/biot_savart_B.cpp', 'cppplasmaopt/biot_savart_dB_by_dX.cpp', 'cppplasmaopt/biot_savart_dB_by_dcoilcoeff.cpp', 'cppplasmaopt/biot_savart_dB_by_dcoilcoeff_via_chainrule.cpp'],
        include_dirs=[
