...
ext_modules = [
    Extension(
        'cppplasmaopt',
        ['cppplasmaopt/main.cpp', 'cppplasmaopt/biot_savart_B.cpp', 'cppplasmaopt/biot_savart_dB_by_dX.cpp', 'cppplasmaopt/biot_savart_dB_by_dcoilcoeff.cpp', 'cppplasmaopt/biot_savart_dB_by_dcoilcoeff_via_chainrule.cpp', 'cppplasmaopt/biot_savart_d2B_by_dXdcoilcoeff.cpp', 'cppplasmaopt/biot_savart_d2B_by_dXdX.cpp'],
        include_dirs=[
